      ...
      <section className="bg-white">
        <div className="container">
          ...
          <div className="row align-items-center">
            ...
            <h6 className='fw-bold my-2'>SPPL is a top MEP (Mechanical, Electrical, and Plumbing) company in India, <br/>delivering end-to-end MEP services with quality and efficiency.</h6>
          </div>
